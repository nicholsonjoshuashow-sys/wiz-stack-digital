                ...
                <NavigationMenuContent>
                  <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] bg-background border border-border">
                      ...
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            24/7 emergency response and containment services
                          </p>
                        </Link>
                      </NavigationMenuLink>
                    </li>
                    ...
                    <li>
                      <NavigationMenuLink asChild>
                        <Link
                          to="/services/training-keynotes"
                          className={cn(
                            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                          )}
                        >
                          <div className="text-sm font-medium leading-none">Training & Keynotes</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                  ...
                  <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-1 lg:w-[600px] bg-background border border-border">
                    ...
                    <li>
                      <NavigationMenuLink asChild>
                        ...
                        >
                          <div className="text-sm font-medium leading-none">News & Insights</div>
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            Latest cybersecurity news, insights, and LinkedIn content
                          </p>
                        </Link>
                      </NavigationMenuLink>
                    </li>
            ...
            <nav className="flex flex-col space-y-4 pt-4">
              ...
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-2">
                  ...
                  <Link to="/services/training-keynotes" className="block text-pearl-white/80 hover:text-cyber-blue transition-colors text-sm">
                    Training & Keynotes
                  </Link>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-2">
                  ...
                  <Link to="/media/news" className="block text-pearl-white/80 hover:text-cyber-blue transition-colors text-sm">
                    News & Insights
                  </Link>
                </div>
              </div>
